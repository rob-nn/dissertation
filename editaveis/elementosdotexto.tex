...
terminologia metrológica usar o Vocabulário Internacional de Termos 
...
Notas eventualmente necessárias devem ser numeradas de forma sequencial ao 
...
Equações matemáticas devem ser numeradas sequencialmente e alinhadas a 
...
pontos deve ser deixado acima, abaixo e entre equações subsequentes. Para uma 
apresentação compacta das equações deve-se usar os símbolos e expressões 
matemáticos mais adequados e parênteses para evitar ambiguidades em 
