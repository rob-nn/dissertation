...
Em \cite{Sup2008}, demonstra-se o projeto de uma prótese transfemural ativas.
...
Em \cite{Vallery2011} é apresentado um enfoque novo para controle de próteses transfemurais ativas.
...
O terceiro modelo encontrado de projeto de controle para próteses transfemurais ativas, foi o de \cite{Borjian2008}. Ele utilizou um controlador \emph{fuzzy}, esepecificamente com o modelo Takagi-Sygeno-Kang (TSK) \emph{fuzzy}. Este é um modelo adaptativo.
