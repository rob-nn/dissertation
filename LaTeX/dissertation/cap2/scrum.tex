...
Após a reunião do \emph{sprint}, inicia-se a iteração. A iteração é também chamda de \emph{sprint} e consiste num prazo de alguns dias ou alguns meses. Isto depende do projeto em questão. Geralmente sprints menores são mais aconselhados, uma semana por exemplo \cite{Schwaber2004}.
