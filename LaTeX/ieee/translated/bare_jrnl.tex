...
\author{
	...
	\thanks{R. A. Lima, V. R. S. Maraes and L. M. Brasil are with Biomedical Engineering Post Graduate Program, Faculdade Gama / Universidade de Brasilia, Gama, DF.}
	\thanks{J. S. S. Melo is whit Tribunal de Justiça do Distrito Federal, Brasilia, DF.}
\thanks{Manuscript received October 23, 2015; revised December 1, 2015.}}
...
\begin{abstract}
	This paper describes the first implementation version of a human gait analysis Software as a Service (SaaS).
	This approach has as advantage, the software availability at web.
	After the software is implanted at a web server, users can access him from a recent
	web browser with support to HTML5.
	The software objective is to minimize the code development necessities by gait analysis researchers, 
	as well as be a useful tool for health professionals interested in human gait analysis.
	The software allows import positionals data from a third party motion captures system,
	...
	often receive new features and a new community is being created to maintain him.
\end{abstract}
...
\IEEEPARstart{W}{ith} the software web advent now is possible to create services,
...
\cite{Duhamel2004}, \cite{Ghoussayni2004}, \cite{Moraes2003}, \cite{Ghoussayni2004},
\cite{Moreno2009}, \cite{Beynon2010}. 
...
One was the Laboratório de Performance Humana (LPH) at 
Faculdade Ceilandia (FCE) / Universidade de Brasilia (UnB), 
and the other was the Laboratório de Informatica em Saude (LIS)
at Faculdade Gama (FGA) / UnB. At LPH data was collected and at
...
Faculdade de Saude da UnB ethics committee, 
process number N11911/12.

\begin{figure}[!t]
	\centering
	\includegraphics[width=2in]{img/data_acq_proc.eps}
...
A scrum \cite{Schwaber2001} inspired process for developement was implanted.
The scrum is a agile method \cite{Beck2001} that has as mainly caracteristics
be iteractive, icremental and change friendly.
These caracteristics are essentials to deal with software requirements volatility
and hence with so common software changes.

The process flux is presented at Fig \ref{dev_proc}.
